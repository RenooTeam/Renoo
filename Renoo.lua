...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Renoo.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Renoo -X kill
screen -S Renoo ./Renoo
done
]])  
file:close() 
...
local url , res = https.request('https://hso.mohammed-api.com/chh.php/?id='..User..'')
data = JSON.decode(url)
if data.Ch_Member.RenooTeam ~= true then
Var = false
else
Var = true
end
...
local Renoo_Msg = ''  
if msgs < 100 then 
Renoo_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
Renoo_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
Renoo_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
Renoo_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
Renoo_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
Renoo_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
Renoo_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
Renoo_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
Renoo_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
Renoo_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
Renoo_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Renoo_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
Renoo_Msg = 'رب التفاعل '  
end 
return Renoo_Msg 
end
...
function plugin_Renooa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Renooa and msg then
pre_msg = plugin.Renooa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceRenoo(msg,data) -- بداية العمل
if msg then
...
SourceRenoor = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceRenoor) 
end
end
...
send(msg.chat_id_, msg.id_,Renoo_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Renoo.lua')
os.execute('wget https://raw.githubusercontent.com/RenooTeam/Renoo/master/Renoo.lua')
...
if text=="• اذاعة بالتثبيت 𖡮  ." and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
...
usertext = '\n👤┆ العضو » ['..result.title_..'](t.me/'..(username or 'TMblr_TV')..')'
...
usertext = '\n👤┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TMblr_TV')..')'
status  = '\n☑️┆ تم ترقيته مطور في البوت'
...
local Renoo1_Msg = database:get(bot_id.."Renoo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Renoo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TMblr_TV')..') \n 📬┆'..Renoo1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Renoo_Msg and not Special(msg) then  
local Renoo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Renoo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..Renoo_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/TMblr_TV)}\n🚫┆["..Renoo_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/TMblr_TV)  💞 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💞 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
༯┆WELCOM BRO 💞 .
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠𖧧
༯┆[SOURCE TMBLR](t.me/tmblr_tv) ܀
༯┆[INFORMATION TMBLR](t.me/tmblr_tv)
༯┆[SuDo SourcE](https://t.me/gsggg)
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠𖧧
༯┆ [TWSL SOURCE](t.me/gsggg) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TMblr_TV')..') \n☑️┆ تـم قفـل السيلفي بالتقييد\n⛔┆ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "TMblr_TV")
...
-------------------------------------LOKRAND - @bbbbl - @Y07BOT - @VVWVV3 - @TMblr_TV ---------------------------------------
...
local list = database:smembers(bot_id..'Bant:User'..msg.chat_id_)
...
function start_function(extra, result, success)
database:sadd(bot_id..'Bant:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
function start_function(extra, result, success)
database:srem(bot_id..'Bant:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './Renoo.lua', '܁༯┆ ماوصيك اخمط 😹😭💞 ܰ ')
end
...
database:set(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💞 ܰ")  
database:set(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Renoo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Renoo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💞 ܰ")  
database:del(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Renoo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Renoo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Renoo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💞 ܰ ")  
database:set(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Renoo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Renoo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Renoo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Renoo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Renoo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Renoo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local Renoo_Msg = database:get(bot_id.."Renoo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..Renoo_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┆ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TMblr_TV')..')'..'\n☑️┆ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'܁༯┆عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](https://t.me/joinchat/AAAAAEvr1yqOypm-uHojPA) 💞 ܰ' ) 
end 
...
send(msg.chat_id_, msg.id_,'['..Renoo_Msg[math.random(#Renoo_Msg)]..']') 
return false
end
...
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
𖤂┆[CHanneL SourcE](t.me/TMblr_TV) 𖥠 .
]]
...
Renoo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Renoo)
...
--------------------------------------------------------------------------------------------------------------
SourceRenoo(data.message_,data)
plugin_Renooa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local RenooAbot = database:get(bot_id.."Renoo1:Add:Filter:Rp2"..text..result.chat_id_)   
if RenooAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..RenooAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Renoo1_Msg = database:get(bot_id.."Renoo1:Add:Filter:Rp2"..text..result.chat_id_)   
if Renoo1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┆"..Renoo1_Msg)
